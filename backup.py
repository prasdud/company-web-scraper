...
def find_company_info(company_name, company_description):
    ...
    website_dork = f'"{company_name}" "{company_description}" official website site:.com OR site:.org OR site:.ai'
    linkedin_dork = f"{company_name} {company_description} site:linkedin.com"
    careers_page_dork = f"{company_name} {company_description} (careers OR jobs) site:.com OR site:.org OR site:.ai"
    jobs_page_dork = f"{company_name} {company_description} jobs site:.com OR site:.org OR site:.ai"
...
def main():
    # Example company
    company_name = "Tandem"
    company_description = "Banking solutions that promote green finance and support eco-friendly financial decisions."
